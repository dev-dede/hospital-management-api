...
class Prescription(models.Model):
    ...
    medication = models.ForeignKey(Medication, on_delete=models.CASCADE, related_name="patient_prescriptions")
    medical_record = models.ForeignKey(MedicalRecord, on_delete=models.CASCADE, related_name="patient_prescriptions")
